...
**You can also review observations on the Checklist Page** by selecting the checkboxes next to the species that require action and then proceed as detailed in [Reviewing Observations](https://docs.google.com/document/d/1gmi74SDISCWFA1CJbfjHqtc4yLOPHlWg9LolSBdFNI0/edit#heading=h.nv3x1bt8ygan) above.  
...
-   **Date of 1 Jan 1900:** eBird allows observers to[ build life lists](https://support.ebird.org/support/solutions/articles/48000804866), country lists etc. by submitting incidental checklists with no start time for 1 Jan 1900. Submissions from this exact date are automatically treated as Not Public with the reason Checklist-List Building. In the rare event that a legitimate historical entry comes from 1 Jan 1900, reviewers can override this designation. Note also that reviewers should mark list building efforts from other dates in the same way, but this is a manual, not automated, process (see [Checklist-level Review Reasons](https://docs.google.com/document/d/1gmi74SDISCWFA1CJbfjHqtc4yLOPHlWg9LolSBdFNI0/edit#heading=h.10igflp6x4d3) below). 
...
-   **Blocklisted Users:** some observers violate eBird terms of use or otherwise do not comply with the[ eBird Code of Conduct](https://support.ebird.org/support/solutions/articles/48000795278). If observers are placed on the eBird blocklist (see [eBird Blocklist](https://docs.google.com/document/d/1gmi74SDISCWFA1CJbfjHqtc4yLOPHlWg9LolSBdFNI0/edit#heading=h.5918rexofwsf) below) all submissions appear as Observer-Suppressed. These blocklisted observers are still able to share checklists, but should not do so, since this review reason will carry over to observations from the non-blocklisted observer. This is not the responsibility of the reviewer to correct, but this should be explained to the users involved if checklists are being shared from a blocklisted account.