...
-   **Blocklisted Users:** some observers violate eBird terms of use or otherwise do not comply with the [eBird Code of Conduct](https://support.ebird.org/support/solutions/articles/48000795278). If observers are placed on the eBird blocklist (see [eBird Blocklist](eBird_Blocklist.qmd)) all submissions appear as Observer-Suppressed. These blocklisted observers are still able to share checklists, but should not do so, since this review reason will carry over to observations from the non-blocklisted observer. This is not the responsibility of the reviewer to correct, but this should be explained to the users involved if checklists are being shared from a blocklisted account.
