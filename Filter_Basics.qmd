...
5.  Once complete, send us the following. You can either email John ([jfg228\@cornell.edu)](mailto:jfg228@cornell.edu), Jenna ([jenna.curtis\@cornell.edu)](mailto:jenna.curtis@cornell.edu) and Marshall ([mji26\@cornell.edu), or post in #review-assignments in Slack.](mailto:mji26@cornell.edu)
    ...
    3.  Region code(s) for which it is to be activated. For most regions, you can get this from the URL of the eBird Explore page, e.g., IN-KL-ER for <https://ebird.org/region/IN-KL-ER>
        ...
        1.  [For pelagic filters, which use arbitrary polygons, please use these instructions:](https://ebird.org/region/IN-KL-ER)[Pelagic Filters in eBird](https://docs.google.com/document/d/1-awQ4B9jH3h8QoV_EVD1SutPgmhm7k1B0i-YugZGU2s/edit)

    4.  [The UserID of any reviewers who need editing access.](https://ebird.org/region/IN-KL-ER)
